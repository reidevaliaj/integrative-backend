...
class PaymentOrder(Base):
    ...
    latest_transaction_ref: Mapped[str | None] = mapped_column(String(255), nullable=True, index=True)
    ...
    provider_mandate_ref: Mapped[str | None] = mapped_column(String(255), nullable=True)
...
class PaymentEvent(Base):
    ...
    provider: Mapped[str] = mapped_column(String(50), default="unconfigured", index=True)
    event_key: Mapped[str | None] = mapped_column(String(255), unique=True, nullable=True, index=True)
